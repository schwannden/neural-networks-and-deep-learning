...
nodes  *   ...     *     ...   *
       ...
       *           *            
       *
    sizes[0]    sizes[l]    sizes[L]
       7           5           3

1. Let L be the last layer, and the first layer is numbered from 0
2. self.sizes[l] is the number of units in lth layer
3. Let x be input data for training, and y be the feedforward final output, then
   For l = 1, ..., L:
       activations[l] = activation_function(zs[l-1]), and
       activations[0] = x, activations[L] = y
   For l = 0, ..., L-1:
       zs[l] = self.weights[l] * activations[l]
"""
...
class Network(object):
    ...
    def __init__(self, sizes):
        ...
        # number of layers (number of hidden layers + 1)
